...
def test_basic_scenario_ids_are_registered_static_scenes() -> None:
    ...
    assert set(BASIC_SCENARIO_IDS).issubset(STATIC_SCENE_IDS)
...
def test_basic_expectations_match_case_and_eq10_matrix() -> None:
    matrix = {
        ...
        "BASIC-05": ("case_3", ("B05_CLV", "B05_CFV"), ("B05_CFV",)),
