...
- registered PNG feature types: `active_maneuver_marker, assigned_clv_cfv_marker, boundary_cap_marker, boundary_risk_marker, cmc_decision_marker, commit_marker, cooperative_request_marker, lane_centerline_quicklook, longitudinal_candidate_marker, maneuver_progress_marker, merge_start_marker, merge_trajectory_marker, merging_zone_boundary_quicklook, planning_speed_consumption_marker, planning_speed_marker, source_chain_marker, trajectory_quicklook`
