...
def build_p17_sumo_network(output_dir: str | Path, config: P17SumoNetworkConfig | None = None) -> P17SumoNetworkFiles:
    cfg = config or P17SumoNetworkConfig()
    out = Path(output_dir)
...
def _sumocfg_xml(config: P17SumoNetworkConfig, net_file: str, routes_file: str) -> ET.Element:
