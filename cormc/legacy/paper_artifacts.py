...
from cormc.simulation_core.pre_freeze import ManeuverTrajectoryState, SimulationState, VehicleState


P14_DETERMINISTIC_BASELINE_SCENARIOS: tuple[str, ...] = ()
P14_DEFAULT_STATIC_MAX_STEPS = 120
...
def run_p14_scenario_artifact_bundle(
    ...
    *,
    ...
    max_steps: int = P14_DEFAULT_STATIC_MAX_STEPS,
    ...
    *,
    ...
    try:
        if tuple(config.scenario_ids) != P14_DETERMINISTIC_BASELINE_SCENARIOS:
            raise RuntimeError("P14 baseline requires the formal static baseline scenario set")
